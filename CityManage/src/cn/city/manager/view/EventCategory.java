...
public class EventCategory  implements BaseCategory{
	final private String[] eventCategory = {"生产安全", "消防安全", "煤气中毒", "环境安全", "食品安全", "药品安全", "违章建筑", "卫生所检查", "无照经营", "矛盾排查", "刑事案件", "交通安全"};
	final private int[] eventCategoryIconId = {R.drawable.ic_safe, R.drawable.ic_fire, R.drawable.ic_gas_poisoning, R.drawable.ic_environment, R.drawable.ic_food, R.drawable.ic_drug, R.drawable.ic_structure, R.drawable.ic_clinic, R.drawable.ic_vendor, R.drawable.ic_dispute, R.drawable.ic_criminal, R.drawable.ic_traffic};
