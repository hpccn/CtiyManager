 ...
 * 演示覆盖物的用法
 */
public class OverlayNavigation extends Activity {
    ...
    public void initOverlay(){
    	 ...
    	 */
         ...
         OverlayItem item1 = new OverlayItem(p1,"违章建筑1","");
         /**
