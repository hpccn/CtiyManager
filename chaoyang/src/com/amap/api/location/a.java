...
import com.amap.api.location.core.GeoPoint.b;
  ...
  implements Runnable
{
  ...
  private a(Context paramContext, LocationManager paramLocationManager)
  {
    ...
    this.a.setKey(d.b(paramContext));
    this.a.setPackageName(d.a());
    this.i = new ArrayList();
  }

  private AMapLocation a(android.location.Location paramLocation)
  {
    AMapLocation localAMapLocation = new AMapLocation(paramLocation);
    GeoPoint.b localb = new i(new GeoPoint.b(localAMapLocation.getLongitude(), localAMapLocation.getLatitude()), null, null, null).a();
    if (localb != null)
    {
      localAMapLocation.setLatitude(localb.b);
      localAMapLocation.setLongitude(localb.a);
    }
    return localAMapLocation;
  }

  private AMapLocation a(com.autonavi.aps.api.Location paramLocation)
  {
    AMapLocation localAMapLocation = new AMapLocation("");
    localAMapLocation.setProvider("lbs");
    localAMapLocation.setLatitude(paramLocation.getCeny());
    localAMapLocation.setLongitude(paramLocation.getCenx());
    localAMapLocation.setAccuracy((float)paramLocation.getRadius());
    localAMapLocation.setTime(System.currentTimeMillis());
    ...
    throws Exception
  {
    ...
    {
      boolean bool = com.amap.api.location.core.b.a(this.k);
      localLocation1 = null;
      if (bool)
      {
    ...
    do
    {
      ...
      i1 = com.amap.api.location.core.b.a;
      localLocation1 = null;
    }
    while (i1 != 1);
  ...
  private void g()
  {
    com.amap.api.location.core.b.c = 1 + com.amap.api.location.core.b.c;
  ...
  public void a(long paramLong, float paramFloat, AMapLocationListener paramAMapLocationListener)
  {
    b localb = new b(paramLong, paramFloat, paramAMapLocationListener);
    this.i.add(localb);
  ...
  public void run()
  {
    while (true)
      if (this.d)
      {
        ...
        label90: b localb = (b)this.i.get(-1 + this.i.size());
        long l1 = f.a();
        float f1;
        label136: long l2;
        label162: long l3;
        ...
        while (true)
        {
          ...
          label248: l2 = this.p;
          break label162;
          label257: l3 = localb.a;
        }
        label267: Message localMessage = this.c.obtainMessage();
        ...
        try
        {
          while (true)
          {
            ...
            {
              com.autonavi.aps.api.Location localLocation = f();
            ...
            if (localObject2 == null)
              break label458;
            localAMapLocation = a(localObject2);
            if (localAMapLocation.equals(this.j))
              break label526;
            this.j = localAMapLocation;
            localb.f = localAMapLocation;
            localMessage.what = f;
        ...
        catch (Exception localException2)
        {
          ...
          while (true)
          {
            ...
            localObject2 = null;
            continue;
            label458: if (f.a(this.n.getLatitude(), this.n.getLongitude()))
            {
              localAMapLocation = a(this.n);
              continue;
            }
            localAMapLocation = new AMapLocation(this.n);
          }
          label507: this.c.sendMessage(localMessage);
          f.a(this.k, localAMapLocation);
        }
        try
        {
          label526: Thread.sleep(this.q);
          monitorexit;
        }
  ...
  public static class b
  {
    ...
    public b(long paramLong, float paramFloat, AMapLocationListener paramAMapLocationListener)
    {
      this.a = paramLong;
      this.b = paramFloat;
