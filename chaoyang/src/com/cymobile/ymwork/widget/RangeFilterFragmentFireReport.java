...
import com.cymobile.ymwork.act.FireServiceReportAct;
import com.cymobile.ymwork.act.FireServiceReportAct.StateHolder;
import com.cymobile.ymwork.adapter.ReportDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragmentFireReport extends ShopReportFragment
  implements ShopRangeReportGroup.OnRangeReportChangeListener
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragmentFireReport.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragmentFireReport.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragmentFireReport.this.dismissRange(true);
          return;
        }
        RangeFilterFragmentFireReport.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    FireServiceReportAct localFireServiceReportAct = (FireServiceReportAct)getActivity();
    if ((localFireServiceReportAct != null) && (localFireServiceReportAct.getStateHolder() != null))
    {
      if (localFireServiceReportAct.getStateHolder().getIsRunningTask())
        localFireServiceReportAct.getStateHolder().cancel();
      localFireServiceReportAct.getStateHolder().startTask(localFireServiceReportAct);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragmentFireReport
