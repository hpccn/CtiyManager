...
import com.cymobile.ymwork.act.NearbySearchActivity.StateHolder;
import com.cymobile.ymwork.adapter.FilterDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragment extends ShopFilterFragment
  implements ShopRangeSelGroup.OnRangeSelChangeListener
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragment.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragment.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragment.this.dismissRange(true);
          return;
        }
        RangeFilterFragment.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    NearbySearchActivity localNearbySearchActivity = (NearbySearchActivity)getActivity();
    if ((localNearbySearchActivity != null) && (localNearbySearchActivity.getStateHolder() != null))
    {
      if (localNearbySearchActivity.getStateHolder().getIsRunningTask())
        localNearbySearchActivity.getStateHolder().cancel();
      localNearbySearchActivity.getStateHolder().startTask(localNearbySearchActivity);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragment
