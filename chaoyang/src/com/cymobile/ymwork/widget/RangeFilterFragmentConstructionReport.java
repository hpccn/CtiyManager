...
import com.cymobile.ymwork.act.ConstrustionFieldReportAct;
import com.cymobile.ymwork.act.ConstrustionFieldReportAct.StateHolder;
import com.cymobile.ymwork.adapter.ReportDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragmentConstructionReport extends ShopReportFragment
  implements ShopRangeReportGroup.OnRangeReportChangeListener
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragmentConstructionReport.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragmentConstructionReport.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragmentConstructionReport.this.dismissRange(true);
          return;
        }
        RangeFilterFragmentConstructionReport.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    ConstrustionFieldReportAct localConstrustionFieldReportAct = (ConstrustionFieldReportAct)getActivity();
    if ((localConstrustionFieldReportAct != null) && (localConstrustionFieldReportAct.getStateHolder() != null))
    {
      if (localConstrustionFieldReportAct.getStateHolder().getIsRunningTask())
        localConstrustionFieldReportAct.getStateHolder().cancel();
      localConstrustionFieldReportAct.getStateHolder().startTask(localConstrustionFieldReportAct);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragmentConstructionReport
