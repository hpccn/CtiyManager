...
public class LoadableListFragmentWithViewAndHeaderPublicReport1 extends FragmentReportActivity
{
  private static final int CONTENT_VIEW_ID = 1515151515;
  private RangeFilterFragmentPublic_Report filterFragment;
  private LinearLayout mLayoutHeader;

  public RangeFilterFragmentPublic_Report getFilterFragment()
  {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.filterFragment = new RangeFilterFragmentPublic_Report();
    this.filterFragment.setShopListDataSource(new ReportDataSource());
    this.mLayoutHeader = ((LinearLayout)findViewById(2131230886));
    this.mLayoutHeader.setId(1515151515);
    getSupportFragmentManager().beginTransaction().add(1515151515, this.filterFragment).commit();
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderPublicReport1
