...
public class LoadableListFragmentWithViewAndHeaderPublicReport extends FragmentListActivity
{
  public static final int CONTENT_VIEW_ID = 10101013;
  private ShopFilterFragmentPublicReport filterFragment;
  ...
  public ShopFilterFragmentPublicReport getFilterFragment()
  {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.filterFragment = new RangeFilterFragmentPublicReport();
    this.filterFragment.setShopListDataSource(new FilterDataSourcePublicReport());
    this.mLayoutHeader = ((LinearLayout)findViewById(2131230886));
    this.mLayoutHeader.setId(10101013);
    getSupportFragmentManager().beginTransaction().add(10101013, this.filterFragment).commit();
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderPublicReport
