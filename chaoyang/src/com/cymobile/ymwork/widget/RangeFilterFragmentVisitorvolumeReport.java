...
import com.cymobile.ymwork.act.VisitorvolumeReportAct;
import com.cymobile.ymwork.act.VisitorvolumeReportAct.StateHolder;
import com.cymobile.ymwork.adapter.ReportDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragmentVisitorvolumeReport extends ShopReportFragment
  implements ShopRangeReportGroup.OnRangeReportChangeListener
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragmentVisitorvolumeReport.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragmentVisitorvolumeReport.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragmentVisitorvolumeReport.this.dismissRange(true);
          return;
        }
        RangeFilterFragmentVisitorvolumeReport.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    VisitorvolumeReportAct localVisitorvolumeReportAct = (VisitorvolumeReportAct)getActivity();
    if ((localVisitorvolumeReportAct != null) && (localVisitorvolumeReportAct.getStateHolder() != null))
    {
      if (localVisitorvolumeReportAct.getStateHolder().getIsRunningTask())
        localVisitorvolumeReportAct.getStateHolder().cancel();
      localVisitorvolumeReportAct.getStateHolder().startTask(localVisitorvolumeReportAct);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragmentVisitorvolumeReport
