...
import com.cymobile.ymwork.act.MainClassFireServiceAct;
import com.cymobile.ymwork.act.MainClassFireServiceAct.StateHolder;
import com.cymobile.ymwork.adapter.FilterDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragmentFire extends ShopFilterFragment
  implements ShopRangeSelGroup.OnRangeSelChangeListener
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragmentFire.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragmentFire.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragmentFire.this.dismissRange(true);
          return;
        }
        RangeFilterFragmentFire.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    MainClassFireServiceAct localMainClassFireServiceAct = (MainClassFireServiceAct)getActivity();
    if ((localMainClassFireServiceAct != null) && (localMainClassFireServiceAct.getStateHolder() != null))
    {
      if (localMainClassFireServiceAct.getStateHolder().getIsRunningTask())
        localMainClassFireServiceAct.getStateHolder().cancel();
      localMainClassFireServiceAct.getStateHolder().startTask(localMainClassFireServiceAct);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragmentFire
