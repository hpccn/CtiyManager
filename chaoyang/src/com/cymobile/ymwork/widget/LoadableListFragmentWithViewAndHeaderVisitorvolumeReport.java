...
public class LoadableListFragmentWithViewAndHeaderVisitorvolumeReport extends FragmentReportActivity
{
  private static final int CONTENT_VIEW_ID = 1212121212;
  private RangeFilterFragmentVisitorvolumeReport filterFragment;
  private LinearLayout mLayoutHeader;

  public RangeFilterFragmentVisitorvolumeReport getFilterFragment()
  {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.filterFragment = new RangeFilterFragmentVisitorvolumeReport();
    this.filterFragment.setShopListDataSource(new ReportDataSource());
    this.mLayoutHeader = ((LinearLayout)findViewById(2131230886));
    this.mLayoutHeader.setId(1212121212);
    getSupportFragmentManager().beginTransaction().add(1212121212, this.filterFragment).commit();
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderVisitorvolumeReport
