...
import com.cymobile.ymwork.act.MainClassConstrustionFieldAct;
import com.cymobile.ymwork.act.MainClassConstrustionFieldAct.StateHolder;
import com.cymobile.ymwork.adapter.FilterDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragmentConstruction extends ShopFilterFragment
  implements ShopRangeSelGroup.OnRangeSelChangeListener
{
  ...
  {
    return paramLayoutInflater.inflate(2130903084, paramViewGroup, false);
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragmentConstruction.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragmentConstruction.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragmentConstruction.this.dismissRange(true);
          return;
        }
        RangeFilterFragmentConstruction.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    MainClassConstrustionFieldAct localMainClassConstrustionFieldAct = (MainClassConstrustionFieldAct)getActivity();
    if ((localMainClassConstrustionFieldAct != null) && (localMainClassConstrustionFieldAct.getStateHolder() != null))
    {
      if (localMainClassConstrustionFieldAct.getStateHolder().getIsRunningTask())
        localMainClassConstrustionFieldAct.getStateHolder().cancel();
      localMainClassConstrustionFieldAct.getStateHolder().startTask(localMainClassConstrustionFieldAct);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragmentConstruction
