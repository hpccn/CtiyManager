...
public class LoadableListFragmentWithViewAndHeaderFire extends FragmentListActivity
{
  public static final int CONTENT_VIEW_ID = 10101012;
  private RangeFilterFragmentFire filterFragment;
  ...
  public RangeFilterFragmentFire getFilterFragment()
  {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.filterFragment = new RangeFilterFragmentFire();
    this.filterFragment.setShopListDataSource(new FilterDataSource());
    this.mLayoutHeader = ((LinearLayout)findViewById(2131230886));
    this.mLayoutHeader.setId(10101012);
    getSupportFragmentManager().beginTransaction().add(10101012, this.filterFragment).commit();
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderFire
