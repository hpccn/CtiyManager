...
public class LoadableListFragmentWithViewAndHeaderConstruction extends FragmentListActivity
{
  public static final int CONTENT_VIEW_ID = 10101011;
  private RangeFilterFragmentConstruction filterFragment;
  ...
  public RangeFilterFragmentConstruction getFilterFragment()
  {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.filterFragment = new RangeFilterFragmentConstruction();
    this.filterFragment.setShopListDataSource(new FilterDataSource());
    this.mLayoutHeader = ((LinearLayout)findViewById(2131230886));
    this.mLayoutHeader.setId(10101011);
    getSupportFragmentManager().beginTransaction().add(10101011, this.filterFragment).commit();
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderConstruction
