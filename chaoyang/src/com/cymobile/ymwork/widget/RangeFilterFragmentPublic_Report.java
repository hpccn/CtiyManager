...
import com.cymobile.ymwork.act.PublicReportAct;
import com.cymobile.ymwork.act.PublicReportAct.StateHolder;
import com.cymobile.ymwork.adapter.ReportDataSource;
import com.cymobile.ymwork.types.Pair;

public class RangeFilterFragmentPublic_Report extends ShopReportFragment
  implements ShopRangeReportGroup.OnRangeReportChangeListener
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.rangeLayout.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        RangeFilterFragmentPublic_Report.this.dismissRange(true);
      }
    });
    ...
    this.btnRangeFilter.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        if (RangeFilterFragmentPublic_Report.this.rangeLayout.getVisibility() == 0)
        {
          RangeFilterFragmentPublic_Report.this.dismissRange(true);
          return;
        }
        RangeFilterFragmentPublic_Report.this.showRange();
      }
    });
    return localView;
  }
  ...
  public void onDataChanged(int paramInt)
  {
    ...
    PublicReportAct localPublicReportAct = (PublicReportAct)getActivity();
    if ((localPublicReportAct != null) && (localPublicReportAct.getStateHolder() != null))
    {
      if (localPublicReportAct.getStateHolder().getIsRunningTask())
        localPublicReportAct.getStateHolder().cancel();
      localPublicReportAct.getStateHolder().startTask(localPublicReportAct);
    }
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.RangeFilterFragmentPublic_Report
