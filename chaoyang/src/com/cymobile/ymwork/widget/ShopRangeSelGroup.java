...
public class ShopRangeSelGroup extends RadioGroup
  implements View.OnClickListener
{
  ...
  public ShopRangeSelGroup(Context paramContext)
  {
    super(paramContext);
  }

  public ShopRangeSelGroup(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public static Pair rangeTypeToPair(int paramInt)
  {
    ...
    if (paramInt == 4)
      return new Pair("4", "本季度");
    if (paramInt == 5)
      return new Pair("5", "本年度");
    int i = Calendar.getInstance().get(1);
    if (paramInt == 6)
      return new Pair(6, i + "年");
    if (paramInt == 7)
 ...
 * Qualified Name:     com.cymobile.ymwork.widget.ShopRangeSelGroup
