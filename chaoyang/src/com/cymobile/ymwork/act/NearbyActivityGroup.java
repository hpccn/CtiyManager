...
public class NearbyActivityGroup extends ActivityGroup
{
  ...
  protected void onResume()
  {
    ...
    Intent localIntent = new Intent(this, MainActivity.class).addFlags(67108864);
    replaceView(group.getLocalActivityManager().startActivity("MainActivity", localIntent).getDecorView());
  }
 ...
 * Qualified Name:     com.cymobile.ymwork.act.NearbyActivityGroup
