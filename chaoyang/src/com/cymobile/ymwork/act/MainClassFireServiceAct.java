...
import com.cymobile.ymwork.widget.ConstrustionFieldListAdapter;
import com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderFire;
...
import com.cymobile.ymwork.widget.RangeFilterFragmentFire;
...
public class MainClassFireServiceAct extends LoadableListFragmentWithViewAndHeaderFire
{
  ...
  public static final String TAG = "MainClassFireServiceAct";
  ...
  private BroadcastReceiver mLoggedOutReceiver = new BroadcastReceiver()
  {
    ...
    {
      Log.i("MainClassFireServiceAct", "onReceive: " + paramIntent);
      MainClassFireServiceAct.this.finish();
    }
  };
  ...
  private void ensureUi()
  {
    ((ImageButton)findViewById(2131230765)).setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        MainClassFireServiceAct.this.onBackPressed();
      }
    });
    ...
    localButton.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        try
        {
          if ((MainClassFireServiceAct.this.mStateHolder != null) && (MainClassFireServiceAct.this.mStateHolder.getShops() != null) && (MainClassFireServiceAct.this.mStateHolder.getShops().size() > 0))
          {
            Intent localIntent = new Intent(MainClassFireServiceAct.this, MapConstrustionFragmentActivity.class);
            FilterDataSource localFilterDataSource = MainClassFireServiceAct.this.getFilterFragment().getFilterDataSource();
            String str = localFilterDataSource.curCategory().id();
            if (str.equals("0"))
              str = MainClassFireServiceAct.this.userZoneId;
            if (MainClassFireServiceAct.this.flag)
            {
              localIntent.putExtra("userZoneId", MainClassFireServiceAct.this.userZoneId);
              localIntent.putExtra("userZoneName", MainClassFireServiceAct.this.userZoneName);
            }
            localIntent.putExtra("Intent_ClassId", MainClassFireServiceAct.this.classid);
            ...
            localIntent.putExtra("EM", MainClassFireServiceAct.this.emphasis);
            MainClassFireServiceAct.this.startActivity(localIntent);
            MainClassFireServiceAct.this.finish();
            return;
          }
          Toast.makeText(MainClassFireServiceAct.this, 2131296391, 1).show();
          return;
        }
  ...
  private void ensureUiListView()
  {
    ...
    localPullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      ...
      {
        ConstrustionField localConstrustionField = (ConstrustionField)MainClassFireServiceAct.this.mListAdapter.getItem(paramInt);
        Intent localIntent = new Intent(MainClassFireServiceAct.this, ShopDetailsFireServiceActivity.class);
    ...
    for (this.mLayoutEmpty = ((ScrollView)localLayoutInflater.inflate(2130903101, null)); ; this.mLayoutEmpty = ((ScrollView)localLayoutInflater.inflate(2130903102, null)))
    {
      ((Button)this.mLayoutEmpty.findViewById(2131230991)).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramView)
        {
          MainClassFireServiceAct.this.mStateHolder.startTask(MainClassFireServiceAct.this);
        }
      });
  ...
  private void sortShopsAreaDesc(Group<ConstrustionField> paramGroup, SeparatedListAdapter paramSeparatedListAdapter)
  {
    ...
    ConstrustionFieldListAdapter localConstrustionFieldListAdapter = new ConstrustionFieldListAdapter(this, this.homeApplication.getRemoteResourceManager());
    ...
    while (true)
    {
      if (!localIterator.hasNext())
      {
        ...
        {
          localConstrustionFieldListAdapter.setGroup(localGroup);
          paramSeparatedListAdapter.addSection(getResources().getString(2131296308), localConstrustionFieldListAdapter);
        }
        return;
      }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (getIntent().getExtras().containsKey("Intent_ClassId"))
    {
      ...
      if (((this.classid == 4) || (this.classid == 6) || (this.classid == 7)) && (!this.flag))
        this.emphasis = getIntent().getExtras().getString("EM");
      if ((this.userZoneId != null) || (this.userZoneName != null))
        break label580;
      ...
      if (this.userZoneId.length() != 6)
        break label571;
      str2 = "全部";
      FilterDataSource.resetTOPCategory(l, str2);
      label381: setContentView(2130903080);
    ...
    while (true)
    {
      ...
      ((PullToRefreshListView)getListView()).setOnAddMoreListener(new PullToRefreshListView.OnAddMoreListener()
      {
        ...
        {
          MainClassFireServiceAct.this.mStateHolder.startMoreTask(MainClassFireServiceAct.this);
        }
      });
      String str1 = this.mPrefs.getString("key_GlobalZoneId", null);
      if (((str1 == null) || (str1.length() != 12)) && ((PreferencesUtils.getSubZone() == null) || (PreferencesUtils.getSubZone().size() <= 0)))
        break label612;
      this.mHandler.sendEmptyMessageDelayed(12, 50L);
      return;
      finish();
      return;
      label571: str2 = this.userZoneName;
      break;
      label580: FilterDataSource.resetTOPCategory(Long.parseLong(this.userZoneId), this.userZoneName);
      break label381;
      label597: this.mStateHolder = new StateHolder();
    }
    label612: this.mHandler.sendEmptyMessageDelayed(11, 10L);
  }
  ...
  {
    if ((this.classid == 4) || (this.classid == 6) || (this.classid == 7))
      this.commonTitle.setText(getResources().getString(2131296426));
    do
    {
      return;
      if (this.classid == 8)
      {
        this.commonTitle.setText("预防煤气中毒安全");
        return;
      }
      if (this.classid == 9)
      {
        this.commonTitle.setText("违法建设");
        return;
      }
      if (this.classid == 10)
      {
        this.commonTitle.setText("出租房屋");
        return;
      }
      if (this.classid == 11)
      {
        this.commonTitle.setText("人口管理");
        return;
      }
      if (this.classid == 12)
      {
      ...
      if (this.classid != 13)
        continue;
      this.commonTitle.setText("证照资质");
      return;
    }
    while (this.classid != 14);
    this.commonTitle.setText("其他");
  }
  ...
  private class GetZoneTask extends AsyncTask<Void, Void, Boolean>
  {
    ...
    public GetZoneTask(MainClassFireServiceAct arg2)
    {
    }

    protected Boolean doInBackground(Void[] paramArrayOfVoid)
    {
      Server localServer = ((HomeApplication)MainClassFireServiceAct.this.getApplication()).getServer();
      try
      {
        String str = MainClassFireServiceAct.this.mPrefs.getString("key_GlobalZoneId", null);
        Group localGroup1 = localServer.getZone(MainClassFireServiceAct.this.contexts, str);
        bool = false;
        ...
        if (localGroup1 != null)
        {
          ...
          if (i > 0)
          {
            MainClassFireServiceAct.this.userSubZones = localGroup1;
            if ((str == null) || (str.length() != 6))
              break label199;
            Group localGroup2 = localServer.getAllComm(MainClassFireServiceAct.this.contexts);
        ...
        while (true)
        {
          if (!localIterator.hasNext())
          {
            PreferencesUtils.setSubZone(MainClassFireServiceAct.this.userSubZones);
            bool = true;
            return Boolean.valueOf(bool);
          }
          Zone localZone = (Zone)localIterator.next();
          MainClassFireServiceAct.this.userSubZones.add(localZone);
        }
      }
      catch (Exception localException)
      {
        while (true)
        {
          ...
          boolean bool = false;
          continue;
          label199: PreferencesUtils.setSubZone(MainClassFireServiceAct.this.userSubZones);
        }
      }
    }
    ...
    protected void onPostExecute(Boolean paramBoolean)
    {
      ...
      {
        MainClassFireServiceAct.this.runOnUiThread(new Runnable()
        {
          public void run()
          {
            Toast.makeText(MainClassFireServiceAct.this, 2131296363, 1).show();
          }
        });
        return;
      }
      FilterDataSource.setCategory(PreferencesUtils.getSubZone());
      MainClassFireServiceAct.this.getFilterFragment().onDataChanged(0);
    }
  ...
  public class StateHolder
  {
    ...
    private MainClassFireServiceAct.TaskMoreShops mMoreTaskShops;
    private boolean mRanOnce = false;
    private Group<ConstrustionField> mShops = new Group();
    private MainClassFireServiceAct.TaskShops mTaskShops;
    ...
    MainClassFireServiceAct.TaskMoreShops getTaskMoreShops()
    {
      return this.mMoreTaskShops;
    }

    MainClassFireServiceAct.TaskShops getTaskShops()
    {
      return this.mTaskShops;
    }

    public void setActivity(MainClassFireServiceAct paramMainClassFireServiceAct)
    {
      if (this.mIsRunningTask)
        this.mTaskShops.setActivity(paramMainClassFireServiceAct);
    }
    ...
    public void setShops(Group<ConstrustionField> paramGroup)
    {
      if (paramGroup.getNumber() == 0)
        MainClassFireServiceAct.this.setCommonTitle();
      while (true)
      {
        this.mShops = paramGroup;
        return;
        if ((MainClassFireServiceAct.this.classid == 4) || (MainClassFireServiceAct.this.classid == 6) || (MainClassFireServiceAct.this.classid == 7))
        {
          if ((MainClassFireServiceAct.this.emphasis != null) && (MainClassFireServiceAct.this.emphasis.equals("1")))
          {
            MainClassFireServiceAct.this.commonTitle.setText("重点单位消防隐患【共" + paramGroup.getNumber() + "件】");
            continue;
          }
          if ((MainClassFireServiceAct.this.emphasis != null) && (MainClassFireServiceAct.this.emphasis.equals("2")))
          {
            MainClassFireServiceAct.this.commonTitle.setText("一般单位消防隐患【共" + paramGroup.getNumber() + "件】");
            continue;
          }
          if ((MainClassFireServiceAct.this.emphasis != null) && (!MainClassFireServiceAct.this.emphasis.equals("")))
            continue;
          MainClassFireServiceAct.this.commonTitle.setText("消防隐患【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid == 8)
        {
          MainClassFireServiceAct.this.commonTitle.setText("预防煤气中毒安全【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid == 9)
        {
          MainClassFireServiceAct.this.commonTitle.setText("违法建设【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid == 10)
        {
          MainClassFireServiceAct.this.commonTitle.setText("出租房屋【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid == 11)
        {
          MainClassFireServiceAct.this.commonTitle.setText("人口管理【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid == 12)
        {
          MainClassFireServiceAct.this.commonTitle.setText("食品安全【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid == 13)
        {
          MainClassFireServiceAct.this.commonTitle.setText("证照资质【共" + paramGroup.getNumber() + "件】");
          continue;
        }
        if (MainClassFireServiceAct.this.classid != 14)
          continue;
        MainClassFireServiceAct.this.commonTitle.setText("其他【共" + paramGroup.getNumber() + "件】");
      }
    }

    public void startMoreTask(MainClassFireServiceAct paramMainClassFireServiceAct)
    {
      if (!this.mIsRunningTask)
      {
        this.mMoreTaskShops = new MainClassFireServiceAct.TaskMoreShops(MainClassFireServiceAct.this, paramMainClassFireServiceAct);
        AsyncTaskUtils.execute(this.mMoreTaskShops);
        this.mIsRunningTask = true;
      }
    }

    public void startTask(MainClassFireServiceAct paramMainClassFireServiceAct)
    {
      if (!this.mIsRunningTask)
      {
        MainClassFireServiceAct.this.setProgressBarIndeterminateVisibility(true);
        this.mTaskShops = new MainClassFireServiceAct.TaskShops(MainClassFireServiceAct.this, paramMainClassFireServiceAct);
  ...
  {
    private MainClassFireServiceAct mActivity;
    private Exception mException;
    private HomeApplication mHomeApplication;

    public TaskMoreShops(MainClassFireServiceAct arg2)
    {
      Object localObject;
      ...
      throws ServerException, IOException
    {
      ...
      if (str.equals("0"))
        str = MainClassFireServiceAct.this.userZoneId;
      int i = SettingBase.getListNum(MainClassFireServiceAct.this.mPrefs);
      if (i < 0)
        i = 50;
      if ((MainClassFireServiceAct.this.classid == 4) || (MainClassFireServiceAct.this.classid == 6) || (MainClassFireServiceAct.this.classid == 7))
      {
        if (MainClassFireServiceAct.this.flag)
          return this.mHomeApplication.getServer().construstionfield(MainClassFireServiceAct.this.contexts, MainClassFireServiceAct.this.classid, MainClassFireServiceAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), MainClassFireServiceAct.this.mStateHolder.getShops().size(), i, null, null, null);
        return this.mHomeApplication.getServer().construstionfield(MainClassFireServiceAct.this.contexts, MainClassFireServiceAct.this.classid, MainClassFireServiceAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), MainClassFireServiceAct.this.mStateHolder.getShops().size(), i, null, null, MainClassFireServiceAct.this.emphasis);
      }
      return this.mHomeApplication.getServer().Extra18(MainClassFireServiceAct.this.contexts, MainClassFireServiceAct.this.classid, MainClassFireServiceAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), MainClassFireServiceAct.this.mStateHolder.getShops().size(), i, null, null, null);
    }
    ...
    public void setActivity(MainClassFireServiceAct paramMainClassFireServiceAct)
    {
      this.mActivity = paramMainClassFireServiceAct;
    }
  }
  ...
  private class TaskShops extends AsyncTask<Void, Void, Group<ConstrustionField>>
  {
    ...
    public TaskShops(MainClassFireServiceAct arg2)
    {
      Object localObject;
      this.mHomeApplication = ((HomeApplication)localObject.getApplication());
      this.mActivity = localObject;
      ...
      throws ServerException, IOException
    {
      ...
      {
        if (MainClassFireServiceAct.this.flag)
          return this.mHomeApplication.getServer().Extra18(MainClassFireServiceAct.this.contexts, MainClassFireServiceAct.this.classid, MainClassFireServiceAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), 0, i, null, null, null);
        return this.mHomeApplication.getServer().construstionfield(MainClassFireServiceAct.this.contexts, MainClassFireServiceAct.this.classid, MainClassFireServiceAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), 0, i, null, null, MainClassFireServiceAct.this.emphasis);
      }
      return this.mHomeApplication.getServer().Extra18(MainClassFireServiceAct.this.contexts, MainClassFireServiceAct.this.classid, MainClassFireServiceAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), 0, i, null, null, null);
    }
  ...
  class UIHandler extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      AsyncTaskUtils.execute(new MainClassFireServiceAct.GetZoneTask(MainClassFireServiceAct.this, MainClassFireServiceAct.this));
    }
  }
}

/* Location:           /mnt/data/hpc-dev/hou/20131220/同步更新文档说明20131220/classes-dex2jar.jar
 * Qualified Name:     com.cymobile.ymwork.act.MainClassFireServiceAct
