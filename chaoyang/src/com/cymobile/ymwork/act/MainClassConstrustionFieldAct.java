...
import com.cymobile.ymwork.widget.LoadableListFragmentWithViewAndHeaderConstruction;
...
import com.cymobile.ymwork.widget.RangeFilterFragmentConstruction;
...
public class MainClassConstrustionFieldAct extends LoadableListFragmentWithViewAndHeaderConstruction
{
  ...
  public static final String TAG = "MainClassConstrustionFieldAct";
  ...
  private BroadcastReceiver mLoggedOutReceiver = new BroadcastReceiver()
  {
    ...
    {
      Log.i("MainClassConstrustionFieldAct", "onReceive: " + paramIntent);
      MainClassConstrustionFieldAct.this.finish();
    }
  };
  ...
  private void ensureUi()
  {
    ((ImageButton)findViewById(2131230765)).setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        MainClassConstrustionFieldAct.this.onBackPressed();
      }
    });
    ...
    localButton.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramView)
      {
        try
        {
          if ((MainClassConstrustionFieldAct.this.mStateHolder != null) && (MainClassConstrustionFieldAct.this.mStateHolder.getShops() != null) && (MainClassConstrustionFieldAct.this.mStateHolder.getShops().size() > 0))
          {
            Intent localIntent = new Intent(MainClassConstrustionFieldAct.this, MapConstrustionFragmentActivity.class);
            FilterDataSource localFilterDataSource = MainClassConstrustionFieldAct.this.getFilterFragment().getFilterDataSource();
            String str = localFilterDataSource.curCategory().id();
            if (str.equals("0"))
              str = MainClassConstrustionFieldAct.this.userZoneId;
            localIntent.putExtra("Intent_ClassId", MainClassConstrustionFieldAct.this.classid);
            ...
            MainClassConstrustionFieldAct.this.startActivity(localIntent);
            MainClassConstrustionFieldAct.this.finish();
            return;
          }
          Toast.makeText(MainClassConstrustionFieldAct.this, 2131296391, 1).show();
          return;
        }
  ...
  private void ensureUiListView()
  {
    ...
    localPullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      ...
      {
        ConstrustionField localConstrustionField = (ConstrustionField)MainClassConstrustionFieldAct.this.mListAdapter.getItem(paramInt);
        Intent localIntent = new Intent(MainClassConstrustionFieldAct.this, ShopDetailsConstructionActivity.class);
    ...
    for (this.mLayoutEmpty = ((ScrollView)localLayoutInflater.inflate(2130903101, null)); ; this.mLayoutEmpty = ((ScrollView)localLayoutInflater.inflate(2130903102, null)))
    {
      ((Button)this.mLayoutEmpty.findViewById(2131230991)).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramView)
        {
          MainClassConstrustionFieldAct.this.mStateHolder.startTask(MainClassConstrustionFieldAct.this);
        }
      });
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      this.commonTitle.setText(getResources().getString(2131296425));
      ...
      ((PullToRefreshListView)getListView()).setOnAddMoreListener(new PullToRefreshListView.OnAddMoreListener()
      {
        ...
        {
          MainClassConstrustionFieldAct.this.mStateHolder.startMoreTask(MainClassConstrustionFieldAct.this);
        }
      });
  ...
  private class GetZoneTask extends AsyncTask<Void, Void, Boolean>
  {
    ...
    public GetZoneTask(MainClassConstrustionFieldAct arg2)
    {
    }

    protected Boolean doInBackground(Void[] paramArrayOfVoid)
    {
      Server localServer = ((HomeApplication)MainClassConstrustionFieldAct.this.getApplication()).getServer();
      try
      {
        String str = MainClassConstrustionFieldAct.this.mPrefs.getString("key_GlobalZoneId", null);
        Group localGroup1 = localServer.getZone(MainClassConstrustionFieldAct.this.contexts, str);
        bool = false;
        ...
        if (localGroup1 != null)
        {
          ...
          if (i > 0)
          {
            MainClassConstrustionFieldAct.this.userSubZones = localGroup1;
            if ((str == null) || (str.length() != 6))
              break label199;
            Group localGroup2 = localServer.getAllComm(MainClassConstrustionFieldAct.this.contexts);
        ...
        while (true)
        {
          if (!localIterator.hasNext())
          {
            PreferencesUtils.setSubZone(MainClassConstrustionFieldAct.this.userSubZones);
            bool = true;
            return Boolean.valueOf(bool);
          }
          Zone localZone = (Zone)localIterator.next();
          MainClassConstrustionFieldAct.this.userSubZones.add(localZone);
        }
      }
      catch (Exception localException)
      {
        while (true)
        {
          ...
          boolean bool = false;
          continue;
          label199: PreferencesUtils.setSubZone(MainClassConstrustionFieldAct.this.userSubZones);
        }
      }
    }
    ...
    protected void onPostExecute(Boolean paramBoolean)
    {
      ...
      {
        MainClassConstrustionFieldAct.this.runOnUiThread(new Runnable()
        {
          public void run()
          {
            Toast.makeText(MainClassConstrustionFieldAct.this, 2131296363, 1).show();
          }
        });
        return;
      }
      FilterDataSource.setCategory(PreferencesUtils.getSubZone());
      MainClassConstrustionFieldAct.this.getFilterFragment().onDataChanged(0);
    }
  ...
  public class StateHolder
  {
    ...
    private MainClassConstrustionFieldAct.TaskMoreShops mMoreTaskShops;
    private boolean mRanOnce = false;
    private Group<ConstrustionField> mShops = new Group();
    private MainClassConstrustionFieldAct.TaskShops mTaskShops;
    ...
    MainClassConstrustionFieldAct.TaskMoreShops getTaskMoreShops()
    {
      return this.mMoreTaskShops;
    }

    MainClassConstrustionFieldAct.TaskShops getTaskShops()
    {
      return this.mTaskShops;
    }

    public void setActivity(MainClassConstrustionFieldAct paramMainClassConstrustionFieldAct)
    {
      if (this.mIsRunningTask)
        this.mTaskShops.setActivity(paramMainClassConstrustionFieldAct);
    }
    ...
    public void setShops(Group<ConstrustionField> paramGroup)
    {
      if (paramGroup.getNumber() == 0)
        MainClassConstrustionFieldAct.this.commonTitle.setText(MainClassConstrustionFieldAct.this.getResources().getString(2131296425));
      while (true)
      {
        this.mShops = paramGroup;
        return;
        MainClassConstrustionFieldAct.this.commonTitle.setText("土方工地【共" + paramGroup.getNumber() + "件】");
      }
    }

    public void startMoreTask(MainClassConstrustionFieldAct paramMainClassConstrustionFieldAct)
    {
      if (!this.mIsRunningTask)
      {
        this.mMoreTaskShops = new MainClassConstrustionFieldAct.TaskMoreShops(MainClassConstrustionFieldAct.this, paramMainClassConstrustionFieldAct);
        AsyncTaskUtils.execute(this.mMoreTaskShops);
        this.mIsRunningTask = true;
      }
    }

    public void startTask(MainClassConstrustionFieldAct paramMainClassConstrustionFieldAct)
    {
      if (!this.mIsRunningTask)
      {
        MainClassConstrustionFieldAct.this.setProgressBarIndeterminateVisibility(true);
        this.mTaskShops = new MainClassConstrustionFieldAct.TaskShops(MainClassConstrustionFieldAct.this, paramMainClassConstrustionFieldAct);
  ...
  {
    private MainClassConstrustionFieldAct mActivity;
    private Exception mException;
    private HomeApplication mHomeApplication;

    public TaskMoreShops(MainClassConstrustionFieldAct arg2)
    {
      Object localObject;
      ...
      throws ServerException, IOException
    {
      ...
      if (str.equals("0"))
        str = MainClassConstrustionFieldAct.this.userZoneId;
      int i = SettingBase.getListNum(MainClassConstrustionFieldAct.this.mPrefs);
      if (i < 0)
        i = 50;
      return this.mHomeApplication.getServer().construstionfield(MainClassConstrustionFieldAct.this.contexts, MainClassConstrustionFieldAct.this.classid, MainClassConstrustionFieldAct.this.userZoneId, FilterDataSource.toDays(localFilterDataSource.curRange().intId()), str, FilterDataSource.getOrderDescStr(localFilterDataSource.curFilterId().intId()), MainClassConstrustionFieldAct.this.mStateHolder.getShops().size(), i, null, null, null);
    }
    ...
    public void setActivity(MainClassConstrustionFieldAct paramMainClassConstrustionFieldAct)
    {
      this.mActivity = paramMainClassConstrustionFieldAct;
    }
  }
  ...
  private class TaskShops extends AsyncTask<Void, Void, Group<ConstrustionField>>
  {
    ...
    public TaskShops(MainClassConstrustionFieldAct arg2)
    {
      Object localObject;
      this.mHomeApplication = ((HomeApplication)localObject.getApplication());
      this.mActivity = localObject;
  ...
  class UIHandler extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      AsyncTaskUtils.execute(new MainClassConstrustionFieldAct.GetZoneTask(MainClassConstrustionFieldAct.this, MainClassConstrustionFieldAct.this));
    }
  }
}

/* Location:           /mnt/data/hpc-dev/hou/20131220/同步更新文档说明20131220/classes-dex2jar.jar
 * Qualified Name:     com.cymobile.ymwork.act.MainClassConstrustionFieldAct
