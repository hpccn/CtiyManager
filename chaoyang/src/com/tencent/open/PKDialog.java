  ...
  implements KeyboardDetectorRelativeLayout.IKeyboardChanged
{
  ...
  public PKDialog(Context paramContext, String paramString, IUiListener paramIUiListener)
  {
    super(paramContext, 16973840);
    sWeakContext = new WeakReference(paramContext);
    this.mUrl = paramString;
    this.mListener = new PKDialog.OnTimeListener(paramIUiListener);
  ...
  private void initViews()
  {
    ...
    this.mWebView.addJavascriptInterface(new PKDialog.JsListener(this, null), "sdk_js_if");
